 ...
 *Lab2- Calculating matrix result depending on user input 
...
public class Matrix {
  private final double[][] array; // 2D array to store the matrix elements
  private final int rows, columns; // variables to store the number of rows and columns
