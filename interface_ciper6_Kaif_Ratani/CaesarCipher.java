...
/**
 * The CaesarCipher class represents the Caesar cipher algorithm for encryption and decryption.
 * 
 * Lab6- CaesarCipher class
 * 
...
public class CaesarCipher extends EncryptionType {
    ...
    public String encrypt(String input) {
        ...
        for (int i = 0; i < input.length(); i++) {
            ...
            char rechar = shiftChar(c, key);
            // Shift the character by the encryption key
    ...
    public String decrypt(String input) {
        ...
        for (int i = 0; i < input.length(); i++) {
            char c = input.charAt(i);
            char rechar = shiftChar(c, -key);
            // Shift the character back by the encryption key
